...
Der derzeitige Transport verwendet kompaktes JSON über `ws`. Für die Alpha ist das transparent und robust; Binärprotokolle und historische Lag Compensation sind als spätere Optimierung vorgesehen.
